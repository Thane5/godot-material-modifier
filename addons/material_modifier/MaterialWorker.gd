		...
		if textField.text.is_empty() == true:
			...
			for property in typedProperties:
				...
				match propertyName:
					...
					"albedo_texture_force_srgb": currentResource.albedo_texture_force_srgb = str_to_var(propertyValue)
					...
					"ao_enabled": currentResource.ao_enabled = str_to_var(propertyValue)
					"ao_light_affect": currentResource.ao_light_affect = propertyValue.to_float()
					"ao_on_uv2": currentResource.ao_on_uv2 = str_to_var(propertyValue)
					...
					"billboard_keep_scale": currentResource.billboard_keep_scale = str_to_var(propertyValue)
					...
					"clearcoat_enabled": currentResource.clearcoat_enabled = str_to_var(propertyValue)
					...
					"detail_enabled": currentResource.detail_enabled = str_to_var(propertyValue)
					...
					"disable_ambient_light": currentResource.disable_ambient_light = str_to_var(propertyValue)
					"disable_receive_shadows": currentResource.disable_receive_shadows = str_to_var(propertyValue)
					...
					"emission_enabled": currentResource.emission_enabled = str_to_var(propertyValue)
					"emission_energy": currentResource.emission_energy = propertyValue.to_float()
					"emission_on_uv2": currentResource.emission_on_uv2 = str_to_var(propertyValue)
					...
					"fixed_size": currentResource.fixed_size = str_to_var(propertyValue)
					"grow": currentResource.grow = str_to_var(propertyValue)
					"grow_amount": currentResource.grow_amount = propertyValue.to_float()
					"heightmap_deep_parallax": currentResource.heightmap_deep_parallax = str_to_var(propertyValue)
					"heightmap_enabled": currentResource.heightmap_enabled = str_to_var(propertyValue)
					"heightmap_flip_binormal": currentResource.heightmap_flip_binormal = str_to_var(propertyValue)
					"heightmap_flip_tangent": currentResource.heightmap_flip_tangent = str_to_var(propertyValue)
					"heightmap_flip_texture": currentResource.heightmap_flip_texture = str_to_var(propertyValue)
					...
					"no_depth_test": currentResource.no_depth_test = str_to_var(propertyValue)
					...
					"particles_anim_loop": currentResource.particles_anim_loop = str_to_var(propertyValue)
					...
					"proximity_fade_enable": currentResource.proximity_fade_enable = str_to_var(propertyValue)
					"refraction_enabled": currentResource.refraction_enabled = str_to_var(propertyValue)
					...
					"rim_enabled": currentResource.rim_enabled = str_to_var(propertyValue)
					...
					"shadow_to_opacity": currentResource.shadow_to_opacity = str_to_var(propertyValue)
					"specular_mode": currentResource.specular_mode = propertyValue.to_int()
					"subsurf_scatter_enabled": currentResource.subsurf_scatter_enabled = str_to_var(propertyValue)
					...
					"texture_repeat": currentResource.texture_repeat = str_to_var(propertyValue)
					"transmission": currentResource.transmission = Color(propertyValue)
					"transmission_enabled": currentResource.transmission_enabled = str_to_var(propertyValue)
					...
					"use_point_size": currentResource.use_point_size = str_to_var(propertyValue)
					"uv1_offset": 
					...
					"uv1_triplanar": currentResource.uv1_triplanar = str_to_var(propertyValue)
					...
					"uv2_triplanar": currentResource.uv2_triplanar = str_to_var(propertyValue)
					"uv2_triplanar_sharpness": currentResource.uv2_triplanar_sharpness = propertyValue.to_float()
					"vertex_color_is_srgb": currentResource.vertex_color_is_srgb = str_to_var(propertyValue)
					"vertex_color_use_as_albedo": currentResource.vertex_color_use_as_albedo = str_to_var(propertyValue)
